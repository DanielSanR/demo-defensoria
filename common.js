...
/* harmony export */   "SobreNosotrosPage": () => (/* binding */ SobreNosotrosPage)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! tslib */ 4929);
/* harmony import */ var _sobre_nosotros_page_html_ngResource__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./sobre-nosotros.page.html?ngResource */ 128);
/* harmony import */ var _sobre_nosotros_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./sobre-nosotros.page.scss?ngResource */ 4324);
...
SobreNosotrosPage = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_4__.Component)({
        ...
        template: _sobre_nosotros_page_html_ngResource__WEBPACK_IMPORTED_MODULE_0__,
        styles: [_sobre_nosotros_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__]
    })
], SobreNosotrosPage);
...
const attachComponent = /*#__PURE__*/function () {
  var _ref = (0,C_proyectos_defensoria_Camara_defensoria_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (delegate, container, component, cssClasses, componentProps, inline) {
    var _a;
...
const CoreDelegate = () => {
  ...
  const attachViewToDom = /*#__PURE__*/function () {
    var _ref2 = (0,C_proyectos_defensoria_Camara_defensoria_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (parentElement, userComponent, userComponentProps = {}, cssClasses = []) {
      var _a, _b;
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,C_proyectos_defensoria_Camara_defensoria_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
      yield new Promise(resolve => (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_1__.c)(el, resolve));
...
/***/ 4324:
/*!********************************************************************!*\
  !*** ./src/app/sobre-nosotros/sobre-nosotros.page.scss?ngResource ***!
  \********************************************************************/
/***/ ((module) => {

module.exports = ".Grid {\n  height: 100%;\n  display: flex;\n  flex-flow: column;\n}\n.Grid-icon {\n  height: 32px;\n  width: 32px;\n}\n.Grid-col-text {\n  padding-top: 0.5rem;\n}\n.Grid-col-text-title-h1 {\n  margin-top: 0rem !important;\n  font-size: 1.2rem !important;\n  font-weight: 700;\n}\n.Grid-col-text-title-p {\n  text-align: justify;\n  margin-top: 0.5rem !important;\n  font-weight: 400;\n  font-size: 0.9rem !important;\n  line-height: 120%;\n}\n.Grid-row {\n  flex-grow: 1;\n}\n.Grid-row-col {\n  text-align: center;\n  padding-top: 0px;\n}\n.Grid-row-col-icon {\n  height: 220px;\n  width: 350px;\n}\n.Grid-col-tyc-text {\n  color: #7B7676;\n  font-weight: 400;\n  font-size: 0.8rem;\n  line-height: 140%;\n}\n.Grid-col-tyc-text-note {\n  font-size: 0.6rem;\n}\n.Grid-button-row {\n  text-align: center;\n}\n.Grid-button-row-col-nextBtn {\n  font-weight: 100;\n  text-transform: none;\n  --background:#FE910E !important;\n  --color:#fff;\n  width: 100%;\n  height: 100%;\n  --padding-bottom: 0.5rem;\n  --border-radius: 0.2rem;\n  --padding-top: 0.5rem;\n  font-size: 1rem;\n}\n.Grid-button-row-col-skipBtn {\n  font-weight: 500;\n  text-transform: none;\n  --color:#FE910E;\n  font-size: 0.9rem;\n}\n/*# sourceMappingURL=data:application/json;base64, */";

/***/ }),

/***/ 128:
/*!********************************************************************!*\
  !*** ./src/app/sobre-nosotros/sobre-nosotros.page.html?ngResource ***!
  \********************************************************************/
/***/ ((module) => {

module.exports = "<ion-content>\n  <ion-grid class=\"Grid\"> \n    \n\n   <ion-row class=\"Grid-row\">\n     <ion-col class=\"Grid-row-col\" size=\"12\">\n       <ion-icon src=\"../../assets/icon/sobre-nosotros.svg\" class=\"Grid-row-col-icon\"></ion-icon>\n     </ion-col>\n     <ion-col size=\"12\" class=\"Grid-col-tyc\">\n       <ion-text class=\"Grid-col-tyc-text\"> \n           <p> Nuestra aplicación se ha creado con el propósito de proporcionar una plataforma segura y fácil de usar para hacer denuncias de abuso sexual, acoso infantil u otra vulneración de los derechos. Sabemos que estos temas son sensibles y difíciles de abordar, y nuestro objetivo es proporcionar un medio para que las víctimas y testigos puedan hacer denuncias de manera anónima y segura. <br>\n            Todas las denuncias que recibimos son manejadas de manera confidencial y se envían a las autoridades competentes para su procesamiento e investigación. Hemos implementado medidas de seguridad para proteger la privacidad y la seguridad de los denunciantes, y nos tomamos muy en serio nuestra responsabilidad de garantizar que estas denuncias se manejen de manera adecuada. <br>\n            Si necesitas más ayuda o asesoramiento después de hacer una denuncia a través de nuestra aplicación, no dudes en ponerte en contacto con nosotros. Estaremos encantados de proporcionar más información o apoyo. Puedes contactarnos a través de nuestra sección de \"Telefono\" en la aplicación o enviando un correo electrónico a nuestro equipo de soporte. Estamos aquí para ayudarte.\n           </p>\n     </ion-text>\n     </ion-col>\n    </ion-row>\n     <ion-row class=\"Grid-button-row\">\n       <ion-col size=\"12\" class=\"Grid-button-row-col\">\n         <ion-button class=\"Grid-button-row-col-nextBtn\" (click)=\"volver()\">Volver</ion-button>\n       </ion-col>\n      </ion-row>\n   </ion-grid>\n</ion-content>\n";
