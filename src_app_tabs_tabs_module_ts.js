...
let HasPermissionDirective = class HasPermissionDirective {
  constructor(formService, renderer, element) {
  ...
  ngAfterViewInit() {
    /*         await this.formService.loadSelected();
            this.formService.getSelectedData().subscribe(
              res=>{
                if(res != this.permission){
...
HasPermissionDirective.ctorParameters = () => [{
  type: _services_form_service__WEBPACK_IMPORTED_MODULE_1__.FormService
}, {
...
HasPermissionDirective = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.Directive)({
...
/* harmony import */ var _has_permission_directive__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./has-permission.directive */ 4888);
...
SharedDirectivesModule = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
        declarations: [_has_permission_directive__WEBPACK_IMPORTED_MODULE_0__.HasPermissionDirective],
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_3__.CommonModule
        ],
        exports: [_has_permission_directive__WEBPACK_IMPORTED_MODULE_0__.HasPermissionDirective]
    })
...
const routes = [
    {
        ...
        children: [
            {
                path: 'inicio',
                loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_home_tab1_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ../home/tab1.module */ 1513)).then(m => m.Tab1PageModule),
...
/* harmony import */ var _directives_shared_directives_module__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../directives/shared-directives.module */ 8665);
